...
Minmax_tweak::Minmax_tweak(Player p, int depth):Minmax(p,depth){	
}

int Minmax_tweak::compare_4(Player p, Board_state val_1, Board_state val_2, Board_state val_3, Board_state val_4, int weight){
